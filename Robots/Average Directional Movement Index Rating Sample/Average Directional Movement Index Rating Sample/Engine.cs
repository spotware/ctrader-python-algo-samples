...
public partial class AverageDirectionalMovementIndexRatingSample
{
    private RobotBridge _robot;
    private bool? _pythonIsSupported;
    private const string MainPythonFile = "Average Directional Movement Index Rating Sample_main.py";
