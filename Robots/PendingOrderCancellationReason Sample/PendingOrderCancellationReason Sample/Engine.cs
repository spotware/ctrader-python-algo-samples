...
public partial class PendingOrderCancellationReasonSample : Robot
{
    private RobotBridge _robot;
    private bool? _pythonIsSupported;
    private const string MainPythonFile = "PendingOrderCancellationReason Sample_main.py";
    ...
    protected override void OnStart()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(PendingOrderCancellationReasonSample);
