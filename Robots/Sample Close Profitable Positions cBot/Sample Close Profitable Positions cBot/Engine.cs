...
public partial class SampleCloseProfitablePositionscBot : Robot
{
    private RobotBridge _robot;
    private const string MainPythonFile = "Sample Close Profitable Positions cBot_main.py";
    ...
    protected override void OnStart()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(SampleCloseProfitablePositionscBot);
