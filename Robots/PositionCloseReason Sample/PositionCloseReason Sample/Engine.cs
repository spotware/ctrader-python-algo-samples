...
public partial class PositionCloseReasonSample : Robot
{
    private RobotBridge _robot;
    private bool? _pythonIsSupported;
    private const string MainPythonFile = "PositionCloseReason Sample_main.py";
    ...
    protected override void OnStart()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(PositionCloseReasonSample);
