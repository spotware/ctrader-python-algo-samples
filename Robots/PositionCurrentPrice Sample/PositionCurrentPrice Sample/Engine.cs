...
public partial class PositionCurrentPriceSample : Robot
{
    private RobotBridge _robot;
    private const string MainPythonFile = "PositionCurrentPrice Sample_main.py";
    ...
    protected override void OnStart()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(PositionCurrentPriceSample);
