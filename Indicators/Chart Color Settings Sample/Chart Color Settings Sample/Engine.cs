...
public partial class ChartColorSettingsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Chart Color Settings Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(ChartColorSettingsSample);;
