...
public partial class ChartColorEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "ChartColorEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(ChartColorEventArgsSample);;
