...
public partial class ToggleButtonSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "ToggleButton Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(ToggleButtonSample);;
