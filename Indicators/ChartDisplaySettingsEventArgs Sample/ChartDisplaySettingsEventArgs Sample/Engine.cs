...
public partial class ChartDisplaySettingsEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "ChartDisplaySettingsEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(ChartDisplaySettingsEventArgsSample);;
