...
public partial class ControlPropertySample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "ControlProperty Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(ControlPropertySample);;
