...
public partial class LineStackingStrategySample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Line Stacking Strategy Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(LineStackingStrategySample);;
