...
public partial class IndicatorTitlesSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "IndicatorTitles Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(IndicatorTitlesSample);;
