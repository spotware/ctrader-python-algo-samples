...
public partial class EquidistantChannelSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Equidistant Channel Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(EquidistantChannelSample);;
