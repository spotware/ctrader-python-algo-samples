...
public partial class RectangleShapeSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Rectangle Shape Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(RectangleShapeSample);;
