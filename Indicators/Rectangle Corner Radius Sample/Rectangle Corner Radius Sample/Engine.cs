...
public partial class RectangleCornerRadiusSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Rectangle Corner Radius Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(RectangleCornerRadiusSample);;
