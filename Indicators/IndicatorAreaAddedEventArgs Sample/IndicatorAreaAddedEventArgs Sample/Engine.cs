...
public partial class IndicatorAreaAddedEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "IndicatorAreaAddedEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(IndicatorAreaAddedEventArgsSample);;
