...
public partial class NegativeVolumeIndex : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Negative Volume Index_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(NegativeVolumeIndex);;
