...
public partial class FibonacciExpansionSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Fibonacci Expansion Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(FibonacciExpansionSample);;
