...
class AndrewsPitchforkSample():
    def initialize(self):
        ...
        y1 = api.Bars.ClosePrices.Last(api.Bars.ClosePrices.Count - barIndex1)
        y2 = api.Bars.ClosePrices.Last(api.Bars.ClosePrices.Count - barIndex2)
        y3 = api.Bars.ClosePrices.Last(api.Bars.ClosePrices.Count - barIndex3)
