...
public partial class IndicatorAreaRemovedEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "IndicatorAreaRemovedEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(IndicatorAreaRemovedEventArgsSample);;
