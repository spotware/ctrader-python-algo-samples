...
public partial class WatchlistAddedEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "WatchlistAddedEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(WatchlistAddedEventArgsSample);;
