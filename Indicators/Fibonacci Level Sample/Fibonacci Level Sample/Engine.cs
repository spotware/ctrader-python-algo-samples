...
public partial class FibonacciLevelSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Fibonacci Level Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(FibonacciLevelSample);;
