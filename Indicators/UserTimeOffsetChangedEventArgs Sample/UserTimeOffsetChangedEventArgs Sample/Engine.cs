...
public partial class UserTimeOffsetChangedEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "UserTimeOffsetChangedEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(UserTimeOffsetChangedEventArgsSample);;
