...
public partial class CoordinatesConversionSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Coordinates Conversion Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(CoordinatesConversionSample);;
