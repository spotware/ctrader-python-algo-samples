...
public partial class CustomControlSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Custom Control Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(CustomControlSample);;
