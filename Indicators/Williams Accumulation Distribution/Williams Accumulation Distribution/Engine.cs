...
public partial class WilliamsAccumulationDistribution : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Williams Accumulation Distribution_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(WilliamsAccumulationDistribution);;
