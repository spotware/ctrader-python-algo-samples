...
public partial class HistoricalTradeSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "HistoricalTrade Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(HistoricalTradeSample);;
