...
public partial class CheckBoxControlSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "CheckBox Control Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(CheckBoxControlSample);;
