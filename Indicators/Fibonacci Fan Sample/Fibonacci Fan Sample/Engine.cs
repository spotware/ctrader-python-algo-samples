...
public partial class FibonacciFanSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Fibonacci Fan Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(FibonacciFanSample);;
