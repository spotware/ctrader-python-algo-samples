...
public partial class VerticalAlignmentSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "VerticalAlignment Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(VerticalAlignmentSample);;
