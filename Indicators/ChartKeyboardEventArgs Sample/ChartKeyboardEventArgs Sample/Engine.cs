...
public partial class ChartKeyboardEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "ChartKeyboardEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(ChartKeyboardEventArgsSample);;
