...
public partial class ChartObjectsSelectionChangedEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "ChartObjectsSelectionChangedEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(ChartObjectsSelectionChangedEventArgsSample);;
