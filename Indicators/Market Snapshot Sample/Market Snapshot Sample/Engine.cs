...
public partial class MarketSnapshotSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Market Snapshot Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(MarketSnapshotSample);;
