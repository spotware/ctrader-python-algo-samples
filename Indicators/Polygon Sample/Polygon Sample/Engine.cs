...
public partial class PolygonSample : Indicator
{
    private const string MainPythonFile = "Polygon Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(PolygonSample);
            ;

            using (var scope = Py.CreateScope())
            {
                scope.Set("currentAssembly", Assembly.GetExecutingAssembly());
