...
public partial class FibonacciRetracementSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Fibonacci Retracement Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(FibonacciRetracementSample);;
