...
public partial class ChartObjectsRemovedEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "ChartObjectsRemovedEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(ChartObjectsRemovedEventArgsSample);;
