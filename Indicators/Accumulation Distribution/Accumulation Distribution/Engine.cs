...
public partial class AccumulationDistribution : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "Accumulation Distribution_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(AccumulationDistribution);;
