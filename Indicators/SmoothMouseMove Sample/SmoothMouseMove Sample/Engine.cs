...
public partial class SmoothMouseMoveSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "SmoothMouseMove Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(SmoothMouseMoveSample);;
