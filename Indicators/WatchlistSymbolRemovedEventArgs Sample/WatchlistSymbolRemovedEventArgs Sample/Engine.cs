...
public partial class WatchlistSymbolRemovedEventArgsSample : Indicator
{
    private IndicatorBridge _indicator;
    private const string MainPythonFile = "WatchlistSymbolRemovedEventArgs Sample_main.py";
    ...
    protected override void Initialize()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(WatchlistSymbolRemovedEventArgsSample);;
